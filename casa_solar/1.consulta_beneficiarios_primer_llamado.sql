...
SELECT 
    ...
    '' AS LIC_Gestidoc,
    '' AS ID_ODOO,
	'Casa Solar 1.0' AS Nombre_Convocatoria,
	1 AS Versión_Convocatoria,
    ...
    '05/11/2020' AS Fecha_de_Publicación, -- Desde Bases
    '' AS Fecha_Cierre,
    ...
    '' AS ID_ODOO_Prov,
    'Casa Solar 1.0' AS Nombre_Convocatoria_Prov,
    ...
    '' AS Fecha_de_Ingreso_de_Gestión, -- Gestidoc o similar
    ...
    'Casa Solar 1.0' AS Nombre_Beneficio,
...
-- Consumos Energéticos - Línea Base
	...
	'Electricidad SEN 2021' AS Nombre_Energético_Base_1,
...
-- Consumos Energéticos - Período de Reporte																			
    ...
    'Electricidad SEN 2022' AS Energético_Reporte_1,
...
-- OTROS
    P.nombre AS _NombreCompleto,
    (SELECT numero_cliente_electricidad FROM ficha_tecnica WHERE ficha_tecnica.id_postulacion=P.id) AS _NumeroCliente,
	PG.estado AS _Estado_Pago,
    PG.tipo AS _Tipo,
    MAX(HP.id_hito) AS _Hito_maximo,
    PC.ceco AS _CECO
